...
**
**  Purpose:
**      Handles the animation of Mario when he gets a mushroom.
*/
        ...
        if (kicking == false) {
            ...
            //If Mario is moving.
                ...
                && (!collision_rectangle(bbox_left,bbox_bottom,bbox_right,bbox_bottom,obj_slippery,0,0)) {
                    ...
                    sprite_index = spr_mario_big_skid;
                }
                ...
                if (!swimming) {
                    ...
                    if (run) {
                        ...
                        if (starjump) {
                            ...
                            sprite_index = spr_mario_big_starjump;
                        }
                        else {
                    ...
                    if (vspeed > 0) {
                        ...
                        sprite_index = spr_mario_big_swim;
                    }
                    else { //Otherwise, if it's diving.
                    
                        //Set the diving pose.
                        sprite_index = spr_mario_big_swim2;
                    }
                }
            }
            ...
            sprite_index = spr_mario_big_kick;
        }
    }
...
if (sprite_index == spr_mario_big_skid) {

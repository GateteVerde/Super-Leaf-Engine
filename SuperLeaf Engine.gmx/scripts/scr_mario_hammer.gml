...
**
**  Purpose:
**      Handles the animation of Mario when he's wearing the Hammer Suit.
*/
    ...
    if (sliding == false) {
        ...
        if (kicking == false) {
            ...
            if (state == 0) {
                ...
                //If Mario is shooting a hammerball.
                if (firing > 0) {
                
                    //Do not animate.
                    image_speed = 0;
                    
                    //Set up the shoot frame.
                    if (firing > 4) {
                    ...
                    //Set up the shooting frame.
                    sprite_index = spr_mario_hammer_shoot;
                }
                else {
            ...
            //If Mario is moving.
                ...
                && (!collision_rectangle(bbox_left,bbox_bottom,bbox_right,bbox_bottom,obj_slippery,0,0)) {
                    ...
                    sprite_index = spr_mario_hammer_skid;
                }
            ...
            //If Mario is doing his trademark pose.
                ...
                if (firing > 0) {
                    ...
                    //Set up the shooting sprite.
                    sprite_index = spr_mario_hammer_shoot2;              
                }
                else {
                    ...
                    if (!swimming) {
                        ...
                        if (run) {
                            ...
                            if (starjump) {
                                ...
                                sprite_index = spr_mario_hammer_starjump;
                            }
                            else {
                        ...
                        if (vspeed > 0) {
                            ...
                            sprite_index = spr_mario_hammer_swim;
                        }
                        else { //Otherwise, if it's diving.
                        
                            //Set the diving pose.
                            sprite_index = spr_mario_hammer_swim2;
                        }
                    }
                }
            }
            ...
            sprite_index = spr_mario_hammer_kick;
        }
    }
...
if (sprite_index == spr_mario_hammer_skid) {

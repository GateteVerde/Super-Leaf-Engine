...
**
**  Purpose:
**      Handles the animation of Mario when he's wearing the Tanooki suit.
*/
                ...
                if (!swimming) {
                    ...
                    if ((run) || (flying) || (global.pwing)) {
                        ...
                        if (starjump) {
                            ...
                            sprite_index = spr_mario_tanooki_starjump;
                        }
                        else {
                    ...
                    if (vspeed > 0) {
                        ...
                        //Set the diving pose.
                        sprite_index = spr_mario_tanooki_swim2;
                    }
                }
            }
...
//Otherwise, if Mario is holding something.
    ...
    if (state < 2) {
        ...
        sprite_index = spr_mario_tanooki_holdjump;
}
